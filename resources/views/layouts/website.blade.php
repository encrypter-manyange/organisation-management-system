...
<head>
    ...
    <title>Webantico Marketplace | {{$page_name}}</title>
        ...
        <div id="loading-center-absolute">
            ...
            <svg viewBox="0 0 49 49" id="soda" class="product">
                <g>
                    ...
                    <path style="fill:#1b445e;" d="M35.5,45h-13c-0.553,0-1-0.447-1-1s0.447-1,1-1h13c0.553,0,1,0.447,1,1S36.053,45,35.5,45z" />
                    <polygon style="fill:#E6E6E6;" points="39.5,32 9.5,42 9.5,20 39.5,10 	" />
                    <polygon style="fill:#7af6f2;" points="39.5,28 9.5,38 9.5,24 39.5,14 	" />
                </g>
            </svg>
